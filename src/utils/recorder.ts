...
const RealTimeSendTry = (rec: any, isClose: boolean) => {
  //实时发送函数
  ...
  let chunk = Recorder.SampleData(rec.buffers, rec.srcSampleRate, sampleRate, realTimeSendTryChunk, {
    frameType: isClose ? '' : 'wav'
  })
